        ...
        <div className='w-full h-auto p-[2%] grid grid-cols-2 bg-[#242537] text-white'>
            ...
            <div>
                <div className='mx-[12%] my-[10%] relative'>
                    ...
                    <h2 className='text-[28px] tracking-[1px] font-bold text-white'>It's all about our <b className='text-[#0065A8]'>Offers</b></h2>
                    <p className='py-[12px] text-[18px] text-white text-justify'>
