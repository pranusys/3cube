    ...
    const features = [
        {
            ...
            content : (
                <div className='w-full h-full ssm:p-[12px] flex flex-col justify-center p-[25px] text-left text-white'>
                    <h2 className='font-bold text-[20px] py-[6px] tracking-[1px] ssm:text-[20px] '>Engage Meaningful with their employees</h2>
                    ...
                    <div className='border-l-2 border-[grey]'>
                        <p className=' text-[14px] py-[6px] text-justify px-[10px]'>
                            We prioritize employee engagement, creating an inclusive, supportive environment 
                            for open communication, professional development, and collaboration. Our 
                            commitment to motivation and empowerment drives company growth.
                        </p>
                    </div>
                </div>
            )
        },
        {
            ...
            content : (
                <div className='w-full h-full ssm:p-[12px] flex flex-col justify-center p-[25px] text-left text-black'>
                    <h2 className='font-bold text-[20px] py-[6px] tracking-[1px] ssm:text-[20px] '>Reduce Employee Attrition</h2>
                    {/* <p className='font-bold text-[20px] py-[6px] ssm:text-[20px]'>Best-in-class devices to help your teams do their best work</p> */}
                    <div className='border-l-2 border-[grey]'>
                        <p className=' text-[14px] py-[6px] text-justify px-[10px]'>
                            We prioritize employee retention, offering competitive compensation, continuous 
                            learning opportunities, and a supportive work 
                            culture to reduce attrition and ensure client satisfaction.
                        </p>
                    </div>
                </div>
            )
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full ssm:p-[12px] flex flex-col justify-center p-[25px] text-left text-white'>
                    <h2 className='font-bold text-[20px] py-[6px] tracking-[1px] ssm:text-[20px] '>Enhance employee performance</h2>
                    {/* <p className='font-bold text-[20px] py-[6px] ssm:text-[20px]'>Best-in-class devices to help your teams do their best work</p> */}
                    <div className='border-l-2 border-[grey]'>
                        <p className=' text-[14px] py-[6px] text-justify px-[10px]'>
                            We prioritize employee engagement, creating an inclusive, supportive environment 
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full text-black flex flex-col justify-center p-[25px] text-left'>
                    <h2 className='font-bold text-[22px] ssm:text-[20px] py-[6px] tracking-[1px] '>Our Support</h2>
                    <div className='border-l-2 border-[grey]'>
                        <p className='text-[14px] py-[6px] text-justify px-[10px]'>
                            3Cube Technologies prioritizes post-sale support, building trust and reliability 
                            to ensure clients' positive experiences with their products or services, 
                            fostering enduring partnerships for sustained satisfaction and success.
                        </p>
                    </div>
                </div>
            )
        },
        {
            ...
            content : (
                <div className='w-full text-white h-full flex flex-col justify-center p-[25px] text-left'>
                    ...
                    <div className='border-l-2 border-[grey]'>
                        <p className='text-[14px] py-[6px] text-justify px-[10px]'>
                            Our team boasts numerous certifications in finance, technology, and security, 
                            demonstrating our commitment to excellence and industry trends, 
                            ensuring innovative solutions consistently exceed client expectations.
                        </p>
                    </div>
                </div>
            )
        },
        {
            ...
            content : (
                ...
                <div className='w-full h-full text-black flex flex-col justify-center p-[25px] text-left'>
                    ...
                    <div className='border-l-2 border-[grey]'>
                        <p className='text-[14px] py-[6px] text-justify px-[10px]'>
                            We specialize in enhancing efficiency and productivity by seamlessly 
                            connecting various technologies, systems, and processes, 
                            simplifying workflows, improving data flow, and creating a unified ecosystem.
                        </p>
                    </div>
                </div>
            )
