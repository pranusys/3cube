  ...
  const features = [
    {
      ...
      content: (
        <div className="w-full h-full flex flex-col justify-center p-[25px] text-left">
          <h2 className="text-[#242537] font-bold text-[22px] py-[6px] tracking-[1px] ">
            Technology Consultation
          </h2>
          <p className="text-[#242537] font-bold text-[22px] py-[6px]">
            Best-in-class devices to help your teams do their best work
          </p>
          <div className="border-l-2 border-[grey]">
            <p className="text-black text-[14px] py-[6px] text-justify px-[10px]">
              Your business needs the best-in-class devices that help boost
              productivity and provide value for money. We help you deploy the
              right computing solutions that streamline business processes,
    ...
    },
    {
      ...
      content: (
        <div className="w-full h-full flex flex-col justify-center p-[25px] text-left">
          ...
          <div className="border-l-2 border-[grey]">
            <p className="text-black text-[14px] py-[6px] text-justify px-[10px]">
              Our financial experts offer tailored mutual fund recommendations
              and management services to help clients diversify their portfolio,
        ...
        <div className="w-full h-full flex flex-col text-white justify-center p-[25px] text-left">
          ...
          <div className="border-l-2 border-[grey]">
            <p className=" text-[14px] py-[6px] text-justify px-[10px]">
              Our team of experts offers comprehensive insurance solutions,
              including life, health, and property coverage, to protect your
              assets, health, and loved ones, ensuring a secure financial
              future.
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="w-full h-full text-black flex flex-col justify-center p-[25px] text-left">
          ...
          <div className="border-l-2 border-[grey]">
            <p className="text-[14px] py-[6px] text-justify px-[10px]">
              We provide customized loan solutions for personal, home, and
              business financing, ensuring competitive terms and responsible
              borrowing, backed by our experienced team.
            </p>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full h-full text-white flex flex-col justify-center p-[25px] text-left">
          ...
          <div className="border-l-2 border-[grey]">
            <p className="text-[14px] py-[6px] text-justify px-[10px]">
              3Cube Technologies utilizes advanced technology to provide
              innovative mobility solutions, enhancing convenience,
              productivity, and connectivity for individuals and businesses,
              ensuring seamless access to information and services.
            </p>
          </div>
        </div>
      ),
