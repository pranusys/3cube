      ...
      <div>
        ...
        >
          <div className="ssm:w-full text-center text-[45px] font-[900] ssm:flex-col ssm:justify-start ssm:items-center ssm:hidden">
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-right text-[#242537]">
              EMPOWERING&nbsp;
            </div>
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-left text-white ssm:text-[#242537]">
              &nbsp;BUSINESS
            </div>
          </div>
          <div className="ssm:w-full text-center text-[28px] tracking-[3px] font-[900] ssm:flex-col py-[6px] ssm:justify-start ssm:items-center ssm:hidden">
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-right text-[#242537]">
              Three Cube Technologies&nbsp;
            </div>
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-left text-white ssm:text-[#242537]">
              &nbsp;Private Limited (TCTPL)
            </div>
          </div>
          <div className="ssm:w-full text-center text-[14px] tracking-[2px] font-[900] py-[6px] ssm:flex-col ssm:justify-start ssm:items-center ssm:hidden">
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-right text-[#242537]">
              Through its innovative & business friendly&nbsp;
            </div>
            <div className="inline-block ssm:none w-1/2 ssm:w-0 text-left text-white ssm:text-[#242537]">
              &nbsp;financial tools aim to help businesses
            </div>
          </div>
          <div className="md:hidden text-center text-[#242537]">
            <h1 className="text-[28px] font-[900] py-[6px]">
              EMPOWERING BUSINESS
            </h1>
            ...
            <p className="text-[14px] py-[6px]">
              Through its innovative & business friendly financial tools aim to
              help businesses.
            </p>
          </div>
