  ...
  return (
    <div 
        style={{
            ...
            <Navbar />
            <div>
              <div className='ssm:bg-white mt-[160px] ssm:mx-auto ssm:rounded-[18px] ssm:w-[90%] ssm:justify-center ssm:items-center ssm:flex ssm:flex-col ssm:p-[2%]'>
            ...
            {/* 
            // */}
            <div className='flex ssm:flex-col justify-center items-center mt-[15px]'>
