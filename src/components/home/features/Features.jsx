    ...
    const features = [
        {
            ...
            content : (
                <div className='w-full h-full flex flex-col justify-center p-[15px] text-left'>
                    ...
                    <p className='text-[#0065A8] text-[16px] ssm:text-[14px]'>Lorem ipsum dolor sit amet.</p>
                    <p className='text-white text-[16px] ssm:text-[14px]'>
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full flex flex-col justify-center text-black items-center text-center'>
                    ...
                    <p className='text-[#4D4F64] text-[16px] ssm:text-[14px] py-[8px]'>
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full flex flex-col justify-center text-white items-center text-center'>
                    <h2 className='text-[35px] ssm:text-[30px] font-bold'>Retail Business</h2>
                </div>
            )
        },
        {
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full flex flex-col justify-center text-white items-center text-center'>
                    <h2 className='text-[35px] ssm:text-[30px] font-bold'>Enterprise Business</h2>
                </div>
            )
        },
        {
            ...
            content : (
                ...
                <div className='w-full h-full text-center flex flex-col text-white justify-center items-center'>
                    ...
                    <p className='text-[16px] ssm:text-[14px] py-[8px]'>
                        “Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                    </p>
                </div>
            )
        ...
        },
        {
            ...
            content : (
                <div className='w-full h-full text-center flex flex-col text-white justify-center items-center'>
                    ...
                    <p className='text-[16px] ssm:text-[14px] py-[8px] text-[#4D4F64]'>
                        “Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                    </p>
                </div>
            )
