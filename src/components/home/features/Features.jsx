  ...
  const features = [
    {
      ...
      content: (
        <div className="w-full h-full flex flex-col text-left justify-center p-[15px]">
          <h2 className="text-white text-[22px] tracking-[1px] ">
      ...
      content: (
        <div className="w-full h-full flex flex-col justify-center text-black items-center text-center">
          ...
          <p className="text-[#4D4F64] text-[14px] py-[8px] px-[5px]">
            "3Cube Technologies prioritizes efficiency and client convenience,
            offering instant approvals for various financial solutions, ensuring
            a seamless and hassle-free experience for clients seeking loans
    ...
    },
    {
      ...
      content: (
        <div className="w-full h-full flex flex-col justify-center text-white items-center text-center">
          <h2 className="text-[35px] ssm:text-[28px] font-bold">
            Retail Business
          </h2>
          <p className="text-[14px] py-[8px] px-[5px]">
            Our retail business prioritizes quality, customer satisfaction, and
            exceptional value, delivering seamless financial experiences and
    ...
    },
    {
      ...
      content: (
        <div className="w-full h-full flex flex-col justify-center text-white items-center text-center">
          ...
          <p className="text-[14px] py-[8px] px-[5px]">
            We offers specialized financial solutions for enterprise businesses,
            focusing on capital allocation, operational efficiency, and complex
    ...
    },
    {
      ...
      content: (
        <div className="w-full h-full text-center flex flex-col text-white justify-center items-center">
          <img
            src={flexibleRepaymentIcon}
            alt="flexible repayment icon"
            className="w-[40px] h-[30px]"
          />
          <h2 className="text-[22px] py-[8px]">Flexible Repayment</h2>
          <p className="text-[14px] py-[8px] px-[5px]">
            We offers customizable repayment solutions, ensuring financial
            stability and alignment with cash flow requirements, empowering
            individuals and businesses to manage their financial commitments
            with ease.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full h-full text-center flex flex-col text-white justify-center items-center">
          <img
            src={higherLoanIcon}
            alt="Higher Loan icon"
            className="w-[40px] h-[35px]"
          />
          <h2 className="text-[22px] py-[8px]">Higher Loan Amount</h2>
          <p className="text-[14px] py-[8px] px-[5px]">
            Our team provides personalized loan solutions, facilitating access
            to significant financial resources for businesses and individuals,
            ensuring their financial success and achieving their ambitions.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full h-full text-center flex flex-col text-white justify-center items-center">
          <img
            src={longerLoanTenureIcon}
            alt="Longer Loan Tenure icon"
            className="w-[40px] h-[35px]"
          />
          <h2 className="text-[22px] text-black py-[8px]">
            Longer Loan Tenure
          </h2>
          <p className="text-[14px] py-[8px] px-[5px] text-[#4D4F64]">
            We offers personalized loan solutions for businesses and individuals
            with significant financial needs, providing access to substantial
            funding to help achieve their goals.
          </p>
        </div>
      ),
    },
